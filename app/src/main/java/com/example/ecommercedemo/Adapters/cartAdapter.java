...
public class cartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public cartAdapter(ArrayList<apiCallProductsDetailResponse> _apiCallProductsDetailResponse, Context con, ProductOnClickCallback productOnClickCallback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(con).inflate(R.layout.cart_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        _viewHolderHeader.deleteItem.setOnClickListener(new View.OnClickListener() {
            @Override
